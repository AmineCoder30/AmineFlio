...
function Contact() {
  ...
  const formContainerRef = useAnimation('fadeUp');
  const mapContainerRef = useAnimation('fadeUp');
  const inputsRef = useAnimation('stagger');
  ...
  return (
    <div className="py-10" id="contact">
      ...
      <div className="mt-10 grid grid-cols-1 lg:grid-cols-2 gap-8">
        {/* Contact Form */}
        <div ref={formContainerRef} className="bg-card-bg border border-border rounded-lg p-6">
          ...
          >
            <div ref={inputsRef}>
              ...
              {/* Budget Field */}
              <div>
                <label htmlFor="budget" className="block text-text-secondary text-sm mb-2">
                  Budget
                </label>
                <input
                  type="text"
        ...
        {/* Map Section */}
        <div ref={mapContainerRef} className="bg-card-bg border border-border rounded-lg p-6">
